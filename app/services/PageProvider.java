...
public class PageProvider {
  ...
  private Map<String, List<String>> mSections;

  public PageProvider(String aPath, String aExtension, Map<String, List<String>> aSections) {
  ...
  public Map<String, Map<String, String>> getSections(Locale aLocale) {
    ...
    for (Map.Entry<String, List<String>> entry: mSections.entrySet()) {
      Map<String, String> pages = new HashMap<>();
      for (String path : entry.getValue()) {
        Map<String, String> page = getPage(path, aLocale);
        if (page != null) {
          pages.put(path, page.get("title"));
        }
      }
