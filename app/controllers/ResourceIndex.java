...
public class ResourceIndex extends OERWorldMap {
  ...
  public Result list(String q, int from, int size, String sort, boolean list, String extension, String select)
    ...
    alternates.put("JSON", baseUrl.concat(routes.ResourceIndex.list(q, from, size, sort, list, "json", select).url().concat(filterString)));
    alternates.put("CSV", baseUrl.concat(routes.ResourceIndex.list(q, from, size, sort, list, "csv", select).url().concat(filterString)));
    if (resourceList.containsType("Event")) {
      alternates.put("iCal", baseUrl.concat(routes.ResourceIndex.list(q, from, size, sort, list, "ics", select).url().concat(filterString)));
    }
